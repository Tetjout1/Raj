...
TOKEN = '7288923119:AAGts72-_uRQAo8koaPokq462DpVytCRUxc'
MONGO_URI = 'mongodb+srv://RAJ:<db_password>@cluster0.pkmfb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
FORWARD_CHANNEL_ID = -1002452490565
CHANNEL_ID = -1002452490565
error_channel_id = -1002452490565
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "*Choose an option by @VIPXDDOS_ADMIN:*", reply_markup=markup, parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/vipcheatsrajddos/12*", parse_mode='Markdown')
        ...
        if user_data:
            ...
            response = "*No account information found. Please contact the administrator @VIPXDDOS_ADMIN.*"
        bot.reply_to(message, response, parse_mode='Markdown')
    elif message.text == "Help❓":
        bot.reply_to(message, "*Help selected @VIPXDDOS_ADMIN*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin selected @VIPXDDOS_ADMIN*", parse_mode='Markdown')
    else:
        bot.reply_to(message, "*https://youtube.com/@y28gaming?si=7XjmKK-ZC84vxqZH*", parse_mode='Markdown')
